...
<div class="box14 table-box-main">
    <h3>
       ...
       <hr>
       <img src= <?php echo plugins_url()."/comments-import-export-woocommerce/images/xadapter.png"; ?>>
   ...
   <!--  <p style="color:red;">
    ...
    <center><a href="https://www.xadapter.com/category/product/wordpress-woocommerce-comments-import-export-plugin/" target="_blank" class="button button-primary">Documentation</a></center>
</div>